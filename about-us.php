    ...
    <div class="container ">
      <div class="aboutus-container-magint-button">
        <div class="row">
          ...
          <div class="col-sm-12">
            <div class="text-center">
              <h4>ยินดีต้อนรับ  <a class="aboutus-size wreath_halftoneregular">"</a> <a class="wreath_halftoneregular">Imgage Studio</a> <a class="aboutus-size wreath_halftoneregular">"</a></h4>
...
<!-- ################################################################################################################### -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <div class="my-3">
              <div class="aboutus-background abotus-bg-mb-5">
                <div class="text-center aboutus-border-fff">
                  <div class="aboutus-border-background">
                     <i class="fa fa-quote-left aboutus-quote-left" aria-hidden="true"></i>
                    <font class="aboutus-font-size">สร้างสรรค์.. ภาพถ่ายธรรมดา ๆ ของคุณให้กลายเป็นการ์ดงานแต่งงาน..แสนสวย..ประทับใจ </font>
                    <i class="fa fa-quote-right aboutus-quote-right" aria-hidden="true"></i>
                  </div>
                </div>
              </div>
